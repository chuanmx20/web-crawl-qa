...
def get_embedding(text: str, engine="text-similarity-davinci-001", **kwargs) -> List[float]:
    ...
    return client.embeddings.create(input=[text], engine=engine, **kwargs)["data"][0]["embedding"]
...
async def aget_embedding(
    ...
    return (await aclient.embeddings.create(input=[text], engine=engine, **kwargs))["data"][0][
        "embedding"
    ]
...
def get_embeddings(
    ...
    data = client.embeddings.create(input=list_of_text, engine=engine, **kwargs).data
...
async def aget_embeddings(
    ...
    data = (await aclient.embeddings.create(input=list_of_text, engine=engine, **kwargs)).data
    return [d["embedding"] for d in data]
